...
| Analog controls or FLX4 feedback generate noisy high-rate events | UART/USB MIDI queue pressure and jitter | S3 translator coalesces high-rate jog/tempo/fader values; legacy panel path accumulates pending jog/browse motion and caps compatibility MIDI bursts; FLX4 VU feedback is treated as low-priority and dropped under MIDI OUT backlog |
