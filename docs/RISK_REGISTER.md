...
| P1 | USB0 media does not recover after boot, remove or active decode fault | Groups A--H plus I1/I2/J1 pass; matrix accounting is 39 PASS, 7 operator-waived and 4 K/L pending | Complete reboot and OTA recovery Groups K/L; do not reopen waived I/J cycles |
