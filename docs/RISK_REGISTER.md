...
| P1 | USB0 media does not recover after boot, remove or active decode fault | Groups A--F pass: cold/warm boots, both insertion orders, five idle removals and five deterministic Library-load removals; progress is 26/50 cycles with FLX4 retained | Complete Group G active load/decode/playback removal and the remaining lifecycle matrix |
