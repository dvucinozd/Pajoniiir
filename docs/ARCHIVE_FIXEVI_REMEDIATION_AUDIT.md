...
> **ARHIVIRANI DUAL-PROCESSOR CLOSEOUT.** Aktualni P4-only release tracker
> nalazi se na izvornom putu `docs/fixevi-remediation-audit.md` nakon
> arhivskog preimenovanja ovog dokumenta.
