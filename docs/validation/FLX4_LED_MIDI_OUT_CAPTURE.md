...
| Beat FX On/Off | global/deck | audio_fx rack | `0x94` / `0x95` | note `0x47` | `0x00` | `0x7F` | implemented | hardware smoke pending | physically verified 2026-06-20 | Beat FX ON/OFF LED followed off/on/off probe; P4 now drives `LED_BEAT_FX_ON` from Beat FX enabled state and clear/reset forces off. |
