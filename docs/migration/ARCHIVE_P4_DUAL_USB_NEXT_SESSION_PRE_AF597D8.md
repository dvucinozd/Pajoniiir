...
> **ARCHIVED PRE-`af597d8` HANDOFF.** The current P4-only continuation plan is
> maintained at the original `P4_DUAL_USB_NEXT_SESSION.md` path after this
> file's archival rename.
