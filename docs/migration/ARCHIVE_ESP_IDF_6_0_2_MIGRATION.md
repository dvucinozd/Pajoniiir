...
> **ARCHIVED DUAL-PROCESSOR MIGRATION RECORD.** The active P4-only IDF 6.0.2
> acceptance matrix is maintained at the original
> `docs/migration/ESP_IDF_6_0_2_MIGRATION.md` path after this file's archival
> rename.
