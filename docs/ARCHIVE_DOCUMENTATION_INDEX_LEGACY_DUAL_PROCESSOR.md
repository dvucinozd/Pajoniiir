...
- [`ARCHIVE_CONTROL_LINK_PROTOCOL.md`](ARCHIVE_CONTROL_LINK_PROTOCOL.md) — fixed `0xA5` events and `0xA6` bulk/profile/status transport.
...
- [`ARCHIVE_POST_R5_PLAN_DUAL_TARGET.md`](ARCHIVE_POST_R5_PLAN_DUAL_TARGET.md) — ordered historical candidate acceptance and enclosure-hardening plan.
...
- [`ARCHIVE_R5_DEAD_CODE_AUDIT.md`](ARCHIVE_R5_DEAD_CODE_AUDIT.md) — completed R5 legacy-path cleanup evidence.
...
- [`ARCHIVE_OTA_UPDATE_PLAN_DUAL_TARGET.md`](ARCHIVE_OTA_UPDATE_PLAN_DUAL_TARGET.md) — OTA design, rollout batches and rollback evidence.
- [`CONTROLLER_PROFILE_UPDATE.md`](CONTROLLER_PROFILE_UPDATE.md) — safe SD profile upload through the P4 web UI/API.
- [`ARCHIVE_S3_WIFI_DEBUG_LOG.md`](ARCHIVE_S3_WIFI_DEBUG_LOG.md) — runtime S3 service AP/log viewer and OTA service.
- [`ARCHIVE_BENCH_NOTES_LEGACY_DUAL_PROCESSOR.md`](ARCHIVE_BENCH_NOTES_LEGACY_DUAL_PROCESSOR.md) — dated hardware bench observations.
...
- [`ARCHIVE_BLE_MIDI_FLX4_FEASIBILITY.md`](ARCHIVE_BLE_MIDI_FLX4_FEASIBILITY.md) — why BLE-MIDI FLX4 support was not planned.
- [`ARCHIVE_BOARD_JC4880P443C_I_W_ANALYSIS_LEGACY.md`](ARCHIVE_BOARD_JC4880P443C_I_W_ANALYSIS_LEGACY.md) — historical P4 board analysis.
- [`ARCHIVE_CONTROL_BOARD_DECISION_S3.md`](ARCHIVE_CONTROL_BOARD_DECISION_S3.md) — historical origin of the two-board decision.
- [`ARCHIVE_FRAMEWORK_DECISION_DUAL_TARGET.md`](ARCHIVE_FRAMEWORK_DECISION_DUAL_TARGET.md) — historical framework decision.
...
- [`migration/ARCHIVE_ESP_IDF_6_0_2_CODE_REVIEW_20260729.md`](migration/ARCHIVE_ESP_IDF_6_0_2_CODE_REVIEW_20260729.md) — pre-merge review of that branch.
