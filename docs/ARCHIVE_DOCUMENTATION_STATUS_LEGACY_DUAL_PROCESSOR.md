...
> **ARHIVIRANI DUAL-PROCESSOR STATUS LEDGER.** Aktualni P4-only status nalazi
> se na izvornom putu `docs/DOCUMENTATION_STATUS.md` nakon arhivskog
> preimenovanja ovog dokumenta.
...
2. active operational documents: `ARCHITECTURE.md`, `ARCHIVE_CONTROL_LINK_PROTOCOL.md`,
   `DDJ_FLX4_MIDI_MAP.md`, `HARDWARE_WIRING.md`, `OTA-UPDATE.md`,
   `CONTROLLER_PROFILE_UPDATE.md`, `ARCHIVE_POST_R5_PLAN_DUAL_TARGET.md` and
