...
> **ARHIVIRANI DUAL-PROCESSOR CHECKLIST.** Ne koristiti za aktualni P4-only
> bring-up ili release. Aktivni checklist nalazi se na izvornom putu
> `docs/STARTUP_CHECKLIST.md` nakon arhivskog preimenovanja ovog dokumenta.
...
- A separate runtime **S3 Debug AP** was added and merged to `master`
  ...
  See
  `docs/ARCHIVE_S3_WIFI_DEBUG_LOG.md` and `docs/ARCHIVE_CONTROL_LINK_PROTOCOL.md`.
