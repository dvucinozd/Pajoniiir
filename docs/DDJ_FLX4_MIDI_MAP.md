...
| Loop In LEDs | `0x90/0x10`, `0x91/0x10` | active audio loop exists | P4 `audio_engine` loop state | Implemented output | Behavior smoke passed D1/D2 2026-06-21; output probe verified 2026-06-20; 2026-06-26 confirmed LED stays off after `IN` alone and turns on with Loop Out once the loop is active |
