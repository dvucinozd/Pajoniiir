...
> **ARHIVIRANI DUAL-PROCESSOR AUDIT.** Ovaj dokument zadržava nalaze i dokaze
> izvornog dvoprocesorskog stabla. Aktivni P4-only gateovi vode se u
> [`fixevi-remediation-audit.md`](fixevi-remediation-audit.md).

Status dokumenta: **povijesni audit; nije aktivni release tracker**
...
- `docs/ARCHIVE_CONTROL_LINK_PROTOCOL.md:140-148`
