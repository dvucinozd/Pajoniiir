 ...
 * Size: 80 px
 * Bpp: 4
 * Opts: --font C:\Users\Daniel\Desktop\splash screen\Musieer-L7nD.ttf --size 80 --format lvgl --bpp 4 --range 0x20-0x7F --no-compress --no-prefilter --force-fast-kern-format --lv-include lvgl.h -o D:\Documents\DDJ-FFL4\firmware\main-deck-p4\components\ui\Musieer_80.c
 ******************************************************************************/
