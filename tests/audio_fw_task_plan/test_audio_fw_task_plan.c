...
static void test_compat_deck_starts_producer_only_task_set(void)
{
...
static void test_non_compat_deck_stays_producer_when_output_is_not_running(void)
{
...
int main(void)
{
    test_compat_deck_starts_producer_only_task_set();
    test_non_compat_deck_starts_producer_only_task_set();
    test_non_compat_deck_stays_producer_when_output_is_not_running();
